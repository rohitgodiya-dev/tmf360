...
const old = `              <AuditTrail user={user} activeStudy={activeStudy} P={P}/>`;

const rep = `              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"8px"}}>
